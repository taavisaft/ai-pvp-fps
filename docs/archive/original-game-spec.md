# Historical starter specification

Archived on 2026-09-05. This records the original design and early deviations; it is not current implementation guidance. Use [AGENTS.md](../../AGENTS.md), [README.md](../../README.md), and [TODO.md](../../TODO.md).
