# Historical environment atlas plan

Archived on 2026-09-05. Several assets described below are no longer present, and these proposed atlas renderers are not implemented. See the [current asset inventory](../../textures/environment/README.md).
